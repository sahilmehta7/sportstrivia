          ...
          <div className="hidden md:flex flex-col sm:flex-row sm:items-center justify-between gap-10 pt-4">
            ...
            <div className="max-w-md w-full">
              <div className="relative group">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/20 to-secondary/20 blur opacity-0 group-focus-within:opacity-100 transition-opacity" />
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="control-public h-14 pl-12 glass border-white/10 text-[10px] font-black tracking-widest uppercase placeholder:text-white/10 focus:border-primary/40 focus:ring-primary/20 transition-all"
                  />
                </div>
              </div>
            </div>
          ...
          {!search && featured.length > 0 && (
            <section className="space-y-10">
              <div className="flex items-center gap-4">
                ...
                <Badge variant="secondary" className="chip-public px-2 py-0 text-[8px] tracking-widest uppercase h-4">HOT</Badge>
              </div>

              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {featured.map((t) => (
                  <Link key={t.id} href={t.href}>
                    <div className="surface-public-raised group relative h-full overflow-hidden glass-elevated border border-white/5 p-8 transition-all hover:bg-white/5 hover:border-primary/20 hover:scale-[1.02]">
                      <div className="relative z-10 flex flex-col h-full justify-between gap-12">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div className="control-public h-10 w-10 glass border border-white/5 flex items-center justify-center">
                              <Database className="h-4 w-4 text-primary" />
                            </div>
                            <div className="text-[10px] font-black tracking-widest uppercase">{t.quizCount ?? 0} DATASETS</div>
                          </div>
                          <div className="control-public h-10 w-10 glass border border-white/5 flex items-center justify-center group-hover:border-primary/40 group-hover:text-primary transition-all">
          ...
          <section className="space-y-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {filteredTopics.map((t) => (
                <Link key={t.id} href={t.href}>
                  <div className="surface-public group relative overflow-hidden glass p-6 border border-white/5 transition-all hover:bg-white/5 hover:border-primary/20">
                    <div className="flex items-start justify-between">
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                          <Badge variant="glass" className="chip-public text-[8px] tracking-[0.2em] font-black px-1.5 py-0 bg-white/5 border-white/5">{t.quizCount ?? 0} PACKS</Badge>
                        </div>
                      </div>

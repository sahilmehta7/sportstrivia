    ...
    <div className={cn("relative group w-full", className)}>
      ...
      <div className="relative overflow-hidden rounded-[3.5rem] glass-elevated border border-white/10 flex flex-col md:flex-row transition-all duration-500 group-hover:border-primary/20 shadow-2xl">
        ...
        <div className="flex-1 p-6 md:p-10 lg:p-16 flex flex-col justify-between gap-6 md:gap-10">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {[
                ...
                <div key={stat.label} className="p-3 md:p-4 rounded-2xl glass border border-white/5 space-y-1 group/stat">
          ...
          {ctaHref && (
            <Button asChild variant="accent" size="xl" className="hidden rounded-2xl px-12 transition-transform group-hover:scale-[1.05] md:inline-flex md:w-fit">
              <Link href={ctaHref}>
                {ctaLabel}
